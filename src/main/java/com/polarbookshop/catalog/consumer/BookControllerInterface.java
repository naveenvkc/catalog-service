...
public interface BookControllerInterface {
   ...
   @RequestMapping(value = "/books/pages/pages", produces = {"application/json"}, method = RequestMethod.GET)
    default ResponseEntity<RestConsumerResponse<Page<PolarBookshopPageProjection>>> getPageableBooks(
